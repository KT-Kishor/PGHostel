sap.ui.define([
  ...
  return BaseController.extend("sap.kt.com.minihrsolution.controller.AutoMobile_Demo", {
    Formatter: Formatter,
    onInit: function () {

      this.getRouter().getRoute("AutoMobile_Demo").attachMatched(this._onRouteMatched, this);
    ...
    var bAutoplay = (vBoxId === "videoBoxA");
