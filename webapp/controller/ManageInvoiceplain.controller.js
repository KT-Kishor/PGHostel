sap.ui.define(
    ...
    function (BaseController, MessageToast, Spreadsheet, Formatter) {
        ...
        return BaseController.extend(
            "sap.ui.com.project1.controller.ManageInvoiceplain", {
            Formatter: Formatter,
            onInit: function () {
                // this._isFinancialYearSet = false;
                this._isFirstInvoiceLoad = true;
                this.getOwnerComponent().getRouter().getRoute("Routecustominvoice").attachMatched(this._onRouteMatched, this);
            },
            ...
            CI_onPressAddInvoice: function () {
                this.getOwnerComponent().getRouter().navTo("Routecustomdetailsinvoice", {
                    sPath: "X",
                    dash: "ManageInvoice"
                });
            },
