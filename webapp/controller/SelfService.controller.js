    ...
    return Controller.extend("sap.kt.com.minihrsolution.controller.SelfService", {
        ...
        _onRouteMatched: async function (oEvent) {
            try {
                ...
                this.byId("SS_id_lca").setValueState("None");
                this.byId("SS_id_lpa").setValueState("None");                
            } catch (error) { } finally {
        ...
        onBeforeUploadStarts: function (oEvent) {
            ...
            if (!utils._LCvalidateMandatoryField(this.byId("SS_id_DocType"), "ID") && !Selected) {
                return MessageToast.show(this.i18nModel.getText("selectDocumentType"));
            }
            this.getBusyDialog();
            ...
            this.showConfirmationDialog(
                ...
                async function () {
                    ...
                    try {
                        ...
                        MessageToast.show(this.i18nModel.getText("DocumentDeleteSuccess"));
        ...
        CommonCalculation:function(){
            ...
            var NewCTC = (CTCType === "Percentage") ? parseFloat(this.latest.CTC) + CtcCalculate : ctcPercentage;
