sap.ui.define(
  ["./BaseController", "../model/formatter", "../utils/validation", "sap/ui/model/json/JSONModel", "sap/m/BusyIndicator", "sap/m/MessageToast", "sap/m/MessageBox", "../utils/SalaryCertificatePDF", "../fonts/EBGaramond", "../fonts/Allura", "../fonts/Poppins", "../fonts/Plight"],
  (Controller, Formatter, utils, JSONModel, BusyIndicator, MessageToast, MessageBox, jsPDF, EBGaramond, Allura, Poppins, Plight) => {
    ...
    return Controller.extend("sap.kt.com.minihrsolution.controller.SelfService", {
      Formatter: Formatter,
      UG_DEGREES: ["BTech/BE", "BSc", "BCom", "BA", "BBA", "BCA", "LLB", "MBBS", "BDS", "BHMS", "BAMS", "BUMS", "BPT", "Diploma"],
      ...
      onInit: function () {
        ...
        oDateModel.setData({
          ...
          nextMonthMinDate: nextMonthFirstDate,
        });
      ...
      _onRouteMatched: async function (oEvent) {
        try {
          ...
          var aIds = ["SS_id_ldob", "SS_id_lb", "SS_id_lpa", "SS_id_lca", "SS_id_Lmo", "SS_id_lr", "SS_id_les", "SS_id_Pf", "SS_id_lName", "SS_id_Rf", "SS_id_Mf",
  "SS_id_Af", "SS_id_Ps", "SS_idEmeSalS", "SS_id_lN", "SS_id_Ms", "SS_id_As", "SS_id_An", "SS_id_Ah", "SS_id_Bn", "SS_id_Bb", "SS_id_Ifc", "SS_id_Ba",
  "SS_id_LPan", "SS_id_LAdhar",
];
          if (this.sPath === "SelfService") {
            ...
            aIds.forEach(
              function (sId) {
                this.byId(sId).setRequired(true);
              }.bind(this)
            );
            ...
            aIds.forEach(
              function (sId) {
                this.byId(sId).setRequired(false);
              }.bind(this)
            );
          }
            ...
            async () => {
              ...
              switch (sectionTitle) {
                ...
                case "Payslip":
                  ...
                  break;
                case "Document":
                  ["SS_id_AcName", "SS_id_Acno", "SS_id_BankName", "SS_id_Branch", "SS_id_IfcsCode", "SS_id_Address", "SS_id_Pan", "SS_idAdhar", "SS_id_Passport", "SS_id_Voterid"].forEach((id) => this.byId(id)?.setValueState("None"));
      ...
      SS_readEducationalDetails: async function (filter, showBusy = true) {
        try {
          ...
          const oData = await this.ajaxReadWithJQuery("EducationalDetails", {
            EmployeeID: filter,
          });
      ...
      SS_readEmploymentDetails: async function (filter, showBusy = true) {
        try {
          ...
          const oData = await this.ajaxReadWithJQuery("EmploymentDetails", {
            EmployeeID: filter,
          });
          const offerData = Array.isArray(oData.data) ? oData.data : [oData.data];
          const oModel = new JSONModel(offerData);
      ...
      SS_commonEduFunction(newStartDate, newEndDate) {
        var eduModel = new JSONModel({
          EmployeeID: this.EmployeeID,
          CollegeName: "",
          DegreeName: "",
          EducationStartDate: newStartDate,
          EducationEndDate: newEndDate,
          Grade: "",
          GradeType: "",
        });
      ...
      SS_onSavePress: function (sButtonId) {
        ...
        if (this.sPath === "SelfService") {
          ...
          const isRequiredValid =
            utils._LCvalidateEmail(oView.byId("SS_id_Compmail"), "ID") && utils._LCstrictValidationComboBox(oView.byId("SS_id_Country"), "ID") && utils._LCstrictValidationComboBox(oView.byId("SS_id_BaseL"), "ID") && utils._LCstrictValidationComboBox(oView.byId("SS_id_Manager"), "ID");
      ...
      EdF_AddEdu: async function () {
        try {
          const oEducationModel = await this.SS_readEducationalDetails(this.EmployeeID, false);
          const oEducationData = oEducationModel ? oEducationModel.getData() : [];
          var latestEndDate = null;
          if (oEducationData && oEducationData.length > 0) {
            oEducationData.sort(function (a, b) {
              var dateA = new Date(a.EducationEndDate);
              var dateB = new Date(b.EducationEndDate);
              return dateB - dateA;
            });
            latestEndDate = new Date(oEducationData[0].EducationEndDate);
          }
          var newMinStartDate;
          if (latestEndDate) {
            newMinStartDate = new Date(latestEndDate);
            newMinStartDate.setDate(newMinStartDate.getDate() + 1);
          } else {
            newMinStartDate = null;
          }
          this.ViewModel.setProperty("/minStartDate", newMinStartDate);
          this.SS_commonEduFunction(null, null);
          ...
          MessageToast.show("Error fetching education details: " + error.message);
        }
      },
      ...
      EdF_DeletEdu: function () {
        ...
        this.showConfirmationDialog(
          ...
          function () {
            that.getBusyDialog();
            that
              .ajaxDeleteWithJQuery("/EducationalDetails", {
                filters: {
                  ID: oContext,
                },
              })
      ...
      EmpF_onDeletEmployment: function () {
        ...
        this.showConfirmationDialog(
          ...
          function () {
            that.getBusyDialog();
            that
              .ajaxDeleteWithJQuery("/EmploymentDetails", {
                filters: {
                  ID: oContext,
                },
              })
      ...
      ReadEmployeeDocument: async function (showBusy = true) {
        try {
          ...
          const oData = await this.ajaxReadWithJQuery("EmployeeDocument", {
            EmployeeID: this.EmployeeID,
          });
          const offerData = Array.isArray(oData.data) ? oData.data : [oData.data];
          const wrappedData = {
      ...
      saveEducationDetails: async function (bIsCreate) {
        try {
          // ---  field validation ---
          const isValid =
            utils._LCvalidateMandatoryField(sap.ui.getCore().byId("AddEd_id_College"), "ID") &&
      ...
      saveEmploymentDetails: function (bIsCreate) {
        try {
          // this.getBusyDialog();
          const isValid =
            utils._LCvalidateMandatoryField(sap.ui.getCore().byId("AddEmp_id_Company"), "ID") &&
      ...
      displaySalaryPanels: function (salaryDetailsArray) {
        ...
        salaryDetailsArray.forEach((offerData, index) => {
          ...
          var sTitleText = isLastRecord
            ...
            : `${this.i18nModel.getText("salaryAppraisalDate")}: ${this.Formatter.formatDate(offerData.AppraisalDate)}, ${this.i18nModel.getText("salaryEffectiveDate")}: ${this.Formatter.formatDate(offerData.EffectiveDate || "")}, ${this.i18nModel.getText(
                "salaryYearlyGross"
              )}: ${this.i18nModel.getText("salaryINR")} ${this.Formatter.fromatNumber(offerData.GrossPay)}`;
          ...
          if (index === 0 && oEffectiveDate < oToday && this.sPath !== "SelfService") {
            var oAppraisalButton = new sap.m.Button({
              ...
              press: function () {
                this._fetchCommonData("TaxCalculation", "TDSModel", {
                  Country: this.getView().getModel("sEmployeeModel").getData()[0].CountryCode,
                });
      ...
      onPressAppraisalSave: async function () {
        ...
        var isCTCValid = CTCType === "Percentage" ? utils._LCvalidateTraineeAmount(sap.ui.getCore().byId("AF_id_CTC"), "ID") : utils._LCvalidateAmount(sap.ui.getCore().byId("AF_id_CTC"), "ID");
      ...
      FCR_onDownloadPDF: async function () {
        ...
        if (this.getView().getModel("PDFData").getProperty("/OnlyRTEFlag")) {
          ...
          try {
            ...
            const salaryResponse = await this.ajaxReadWithJQuery("SalaryDetails", {
              EmployeeID: empID,
            });
            let latestSalary;
          ...
          if (!oCompanyDetailsModel.companylogo64 && !oCompanyDetailsModel.signature64 && !oCompanyDetailsModel.backgroundLogoBase64) {
            try {
              ...
              const [logoBase64, signBase64, backgroundBase64] = await Promise.all([this._convertBLOBToImage(logoBlob), this._convertBLOBToImage(signBlob), this._convertBLOBToImage(backgroundBlob)]);
      ...
      FSA_onPressSubmit: async function () {
        try {
          ...
          var coImg = await this._convertBLOBToImage(
            new Blob([new Uint8Array(oComapnyModel.companylogo?.data)], {
              type: "image/png",
            })
          );
          ...
          doc.setFontSize(37);
          doc.text("SPOT AWARD", pageMiddle, 4, {
            align: "center",
          });
          doc.setFont("helvetica", "normal");
          doc.setFontSize(20);
          doc.text("This certificate is proudly presented to", pageMiddle, 5.5, {
            align: "center",
          });
          doc.setFont(Allura.name, Allura.style);
          doc.setFontSize(45);
          doc.setTextColor(0, 0, 0);
          doc.text(oName, pageMiddle, 8.5, {
            align: "center",
          });
          doc.setFont("times", "normal");
          doc.setFontSize(15);
          doc.text(".............................................................................................................................................", pageMiddle, 9.5, {
            align: "center",
          });
          doc.setFont("helvetica", "normal");
          doc.setFontSize(15);
          doc.text("Excellence in overcoming challenges and timely delivery of solution", pageMiddle, 10.5, {
            align: "center",
          });
          doc.text("in new technology areas.", pageMiddle, 11.5, {
            align: "center",
          });
          doc.setFont(Poppins.name, Poppins.style);
          doc.setFontSize(16);
          doc.text(oNominee, 7, 15, {
            align: "center",
          });
          doc.setFont("times", "normal");
          doc.setFontSize(15);
          ...
          doc.setFont(Poppins.name, Poppins.style);
          doc.setFontSize(16);
          const formattedDate = sap.ui.core.format.DateFormat.getInstance({
          ...
          doc.text(formattedDate, pageMiddle, 15, {
            align: "center",
          });
          doc.setFont("times", "normal");
          doc.setFontSize(15);
          doc.text("...............................", pageMiddle, 15.5, {
            align: "center",
          });
          doc.setFont(Poppins.name, Poppins.style);
          doc.setFontSize(16);
          doc.text(oComapnyModel.headOfCompany, pageWidth - 7, 15, {
            align: "center",
          });
          doc.setFont("times", "normal");
          doc.setFontSize(15);
          doc.text("...............................", pageWidth - 7, 15.5, {
            align: "center",
          });
          // Labels
          doc.setFont(Plight.name, Plight.style);
          doc.setFontSize(12);
          doc.text("Nominated by", 7, 16, {
            align: "center",
          });
          doc.text("Date", pageMiddle, 16, {
            align: "center",
          });
          doc.text(oComapnyModel.designation, pageWidth - 7, 16, {
            align: "center",
          });
      ...
      CC_onPressSubmit: async function () {
        try {
          ...
          const isAllDataPresent =
            oModelData.EmployeeID && oModelData.EmployeeName && oModelData.Designation && oModelData.Email && oModelData.DOB && oModelData.MobileNo && oModelData.BloodGroup && oModelData.BaseLocation && oModelData.BranchCode && (oModelData.ProfilePhoto || oModelData.Attachment);
          if (isAllDataPresent) {
      ...
      _onPressPreview: function (flag) {
        ...
        if (flag !== "Initial") {
          if (!utils._LCvalidateMandatoryField(sap.ui.getCore().byId("RF_id_ResignReason"), "ID") || !utils._LCvalidateDate(sap.ui.getCore().byId("RF_id_StartDate"), "ID") || !utils._LCvalidateDate(sap.ui.getCore().byId("RF_id_EndDate"), "ID")) {
            MessageToast.show(this.i18nModel.getText("mandetoryFields"));
            return;
          }
...
`;
      ...
      SS_onChangeCountry: function (oEvent) {
        ...
        this.onCountryChange(oEvent, {
          stdCodeCombo: "SS_id_STDCode",
          baseLocationCombo: "SS_id_BaseL",
          branchInput: "SS_id_BranchCode",
          mobileInput: "SS_id_MobileNo",
        });
      },
