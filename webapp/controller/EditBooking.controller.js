sap.ui.define([
    ...
    return BookingController.extend("sap.ui.com.project1.controller.EditBooking", {
        ...
        onConfirmMemberSelection: function () {
            BookingController.prototype.onConfirmMemberSelection.apply(this, arguments);
        },

        onDeleteFamilyMemberRow: function (oEvent) {
            BookingController.prototype.onDeleteFamilyMemberRow.call(this, oEvent);
        },
        ...
        onGeneratePDF: async function (data) {
            ...
            let address = doc.splitTextToSize(company.Address || "Kalpavriksha Karekal layout, Near, Railway Bridge, Kalaburagi, Karnataka", iLeftWidth);
