sap.ui.define([
    ...
    return BaseController.extend("sap.kt.com.minihrsolution.controller.DetailLeave", {
        ...
        _onRouteMatched: async function(oEvent) {
            ...
            const response = await this.ajaxReadWithJQuery("InboxDetails", {
                ID: sParams
            });
            ...
            var barDataModel = new JSONModel({
                Name: 'line',
                type: 'column',
                AllStatus: 'column'
            });
       ...
       DL_onBack: function () {
        ...
        MonthBarDisplayFunction: async function(leaveType, selectedYear, userId) {
            ...
            try {
                ...
                this.closeBusyDialog(); //  Close BusyDialog
                let oLeaveModel = new JSONModel({
                    chartData: oData.results
                });
                ...
                oVizFrame.setVizProperties({
                    ...
                    title: {
                        visible: true,
                        text: this.i18nModel.getText("monthlyApprovedLeaveQuota")
                    }
                });
        ...
        YearlyBarDisplayFunction: async function(userId) {
            ...
            try {
                ...
                oVizFrame.setVizProperties({
                    ...
                    title: {
                        visible: true,
                        text: this.i18nModel.getText("yearlyApprovedLeaveQuota")
                    }
                });
                oVizFrame.setModel(oLeaveModel);
                var oPopOver = this.getView().byId("AL_id_PopOver");
